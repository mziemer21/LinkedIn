...
namespace LinkedIn
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String eURL = HttpUtility.UrlEncode("http://www.linkedin.com/pub/matthew-ziemer/6b/646/aa3");
            // request url + encoded user url + data we want returned back
            // data we can get https://developer.linkedin.com/documents/profile-api
            // right now I am only getting first name, last name, and profile picture
            string dataResponse = _oauth.oAuthWebRequest(oAuthLinkedIn.Method.GET, "https://api.linkedin.com/v1/people/url=" + eURL + ":(first-name,last-name,picture-url)", "");
            string url, fName, lName;

            // Create an XmlReader
            using (XmlReader reader = XmlReader.Create(new StringReader(dataResponse)))
            {
                ...
                reader.ReadToFollowing("picture-url");
                url = reader.ReadElementContentAsString();
            }

            imgLIN.Attributes.Add("src", url);
            responsetxt.Text = fName + " " + lName;
    ...
    public class oAuthLinkedIn : oAuthBase2
    {
        ...
        // our api keys
        private string _consumerKey = "YOUR KEY HERE";
        private string _consumerSecret = "YOUR KEY HERE";
        private string _token = "YOUR KEY HERE";
        private string _tokenSecret = "YOUR KEY HERE";
    ...
    public class oAuthBase2
    {
            ...
            out string normalizedRequestParameters)
        {
            ...
            normalizedUrl = url.OriginalString;
    ...
    // overrides the .Net URI class so we can send a partially encoded url
